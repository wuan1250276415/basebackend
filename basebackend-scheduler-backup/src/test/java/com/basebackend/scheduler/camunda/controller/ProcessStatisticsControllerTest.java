...
public class ProcessStatisticsControllerTest {
    ...
    @MockBean
    private com.basebackend.scheduler.monitoring.metrics.WorkflowMetrics workflowMetrics;

    @MockBean
    private com.basebackend.observability.metrics.BusinessMetrics businessMetrics;

    @MockBean
    private com.basebackend.common.starter.properties.CommonProperties commonProperties;

    @MockBean
    private com.basebackend.jwt.JwtUtil jwtUtil;
