export default {
  ...
  menu: {
    ...
    ticketApproval: 'Pending Approval',
  ...
  ticket: {
    ...
    rejectReasonRequired: 'Reason is required when rejecting',
    // Operations
    refresh: 'Refresh',
    ...
    batchCloseSuccess: 'Batch closed successfully',
    ...
    statusChangeRemark: 'Enter remark (optional)',
    assigneeId: 'Assignee ID',
    assigneeName: 'Assignee Name',
    unassigned: 'Unassigned',
    // Create Steps
    stepBasicInfo: 'Basic Info',
    stepBasicInfoDesc: 'Title, category, priority',
    stepDescAttach: 'Details & Attachments',
    stepDescAttachDesc: 'Description and related files',
    ...
    uploadSizeLimit: 'Max file size: 10MB',
    none: 'None',
    // Comments
    commentPlaceholder: 'Enter a comment...',
    internalNotePlaceholder: 'Enter an internal note (visible internally only)...',
    internalNote: 'Internal Note (internal only)',
