 ...
 */
@Component
@ConditionalOnProperty(prefix = "scheduler.workflow.executor", name = "enabled", havingValue = "true", matchIfMissing = false)
public class WorkflowExecutor {
    ...
    public WorkflowExecutor(ProcessorRegistry processorRegistry,
        ...
        this(processorRegistry, retryTemplate, metricsCollector, idempotentCache, createBoundedExecutor(), Duration.ofMinutes(5));
    }

    /**
     * 创建有界线程池，避免无界线程池导致的OOM风险。
     * 配置：核心线程8，最大线程32，队列容量200，空闲60秒回收。
     */
    private static ExecutorService createBoundedExecutor() {
        return new java.util.concurrent.ThreadPoolExecutor(
                ...
                new java.util.concurrent.LinkedBlockingQueue<>(200), // 有界队列
                r -> {
