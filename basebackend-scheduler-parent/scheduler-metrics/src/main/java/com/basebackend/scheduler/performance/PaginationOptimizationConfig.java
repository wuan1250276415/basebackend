...
public class PaginationOptimizationConfig {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PaginationOptimizationConfig.class);
    ...
    public static class PaginationPerformanceMonitor {
        ...
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PaginationPerformanceMonitor.class);
