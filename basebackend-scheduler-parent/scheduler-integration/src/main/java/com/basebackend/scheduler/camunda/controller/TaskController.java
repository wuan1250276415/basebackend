...
public class TaskController {
    ...
    @Operation(
        summary = "分页查询任务",
        description = "支持租户、流程实例、任务分配人、候选用户/组过滤的任务分页查询"
    )
    @GetMapping
    ...
    @Operation(
        summary = "获取任务详情",
        description = "根据任务 ID 获取详细信息，可选择是否返回任务变量"
    )
    @GetMapping("/{taskId}")
    ...
    @Operation(
        summary = "释放任务",
        description = "将已认领的任务释放，使其变为候选任务"
    )
    ...
    @Operation(
        summary = "完成任务",
        description = "完成任务并推进流程实例，包含可选的输出变量"
    )
    ...
    @Operation(
        summary = "获取任务变量",
        description = "返回任务的所有变量，支持本地变量过滤"
    )
    ...
    @Operation(
        summary = "设置任务变量",
        description = "设置或更新指定任务变量，支持本地变量设置"
    )
    ...
    @Operation(
        summary = "删除任务变量",
        description = "删除指定的任务变量，支持本地变量删除"
    )
    ...
    @Operation(
        summary = "添加任务附件",
        description = "为任务添加新的附件，支持外部 URL 引用"
    )
