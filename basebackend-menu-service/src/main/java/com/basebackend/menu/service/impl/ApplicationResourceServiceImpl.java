package com.basebackend.menu.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.basebackend.menu.dto.ApplicationResourceDTO;
import com.basebackend.menu.entity.SysApplicationResource;
import com.basebackend.menu.mapper.SysApplicationResourceMapper;
import com.basebackend.menu.mapper.SysRoleResourceMapper;
import com.basebackend.menu.mapper.SysRoleMenuMapper;
...
public class ApplicationResourceServiceImpl implements ApplicationResourceService {
    ...
    public List<ApplicationResourceDTO> getUserResourceTreeByUserId(Long userId) {
        // TODO: 通过 Feign 调用 auth-service 检查用户是否有 admin 角色
        // 目前简化处理：直接查询用户有权限的资源
        boolean isAdmin = false; // 暂时硬编码为 false
