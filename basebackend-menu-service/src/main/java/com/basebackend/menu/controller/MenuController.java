package com.basebackend.menu.controller;

import com.basebackend.common.constant.CommonConstants;
import com.basebackend.common.model.Result;
import com.basebackend.jwt.JwtUtil;
import com.basebackend.menu.dto.ApplicationResourceDTO;
import com.basebackend.menu.dto.MenuDTO;
import com.basebackend.menu.service.ApplicationResourceService;
...
public class MenuController {
    ...
    public Result<List<MenuDTO>> getRoutes() {
        ...
        try {
            ...
            // 转换为MenuDTO格式
            List<MenuDTO> routes = convertResourceToMenu(resourceTree);
    ...
    public Result<List<MenuDTO>> getMenuTreeByUserId(@Parameter(description = "用户ID") @PathVariable Long userId) {
        ...
        try {
            // 获取用户有权限的资源树
            List<ApplicationResourceDTO> resourceTree = applicationResourceService.getUserResourceTreeByUserId(userId);
    ...
    private MenuDTO toMenuDTO(ApplicationResourceDTO resource) {
        ...
        menu.setCreateTime(resource.getCreateTime());
        menu.setUpdateTime(resource.getUpdateTime());
        menu.setCreateBy(resource.getCreateBy());
        menu.setUpdateBy(resource.getUpdateBy());
