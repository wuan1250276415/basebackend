...
public class MyBatisPlusConfig {
    ...
    public ObjectMapper objectMapper() {
        ...
        // Register JavaTimeModule for Java 8 date/time support (LocalDateTime, LocalDate, etc.)
     ...
     * Note: AuditInterceptor is registered separately as it's a standard MyBatis Interceptor,
     * not an InnerInterceptor. It will be registered to SqlSessionFactory via @PostConstruct.
     */
    @Bean
     ...
     * Note: DecryptionInterceptor is registered separately as it's a standard MyBatis Interceptor,
     * not an InnerInterceptor. It intercepts result set handling to decrypt sensitive fields.
     */
    @Bean
     ...
     * Note: PermissionMaskingInterceptor is registered separately as it's a standard MyBatis Interceptor,
     * not an InnerInterceptor. It intercepts result set handling to mask sensitive fields based on user permissions.
     * This interceptor runs after DecryptionInterceptor to ensure data is decrypted before masking decisions are made.
     */
    @Bean
     ...
     * Note: SqlExecutionTimeInterceptor is registered separately as it's a standard MyBatis Interceptor,
     * not an InnerInterceptor. It intercepts SQL execution to measure execution time and identify slow queries.
     */
    @Bean
     ...
     * Note: DataScopeInterceptor is registered separately as it's a standard MyBatis Interceptor,
     * not an InnerInterceptor. It intercepts SQL execution to apply data permission filtering.
     */
    @Bean
